    ...
    <header className="fixed top-0 inset-x-0 z-40">
      <div className="mx-auto max-w-7xl px-6 pt-5">
        ...
        >
          ...
          <a
            href="#top"
            className="font-mono text-sm tracking-tight text-white/90 hover:text-white transition-colors"
          >
          ...
          <nav className="hidden md:flex items-center gap-1 rounded-full border border-white/10 bg-white/[0.03] p-1">
            {ROLE_ORDER.map((key) => {
              ...
              return (
                ...
                >
                  {building ? (
                    <span className="mr-1.5 inline-flex align-middle relative h-2.5 w-2.5" aria-label="building">
                      <span
