...
import { ROLES, SKILL_CATEGORIES, type RoleKey } from '@/lib/data'
...
export default function Skills({ activeRole }: SkillsProps) {
    ...
    <section id="skills" className="relative py-20">
      <div className="mx-auto max-w-7xl px-6">
        <div className="flex items-end justify-between gap-6">
          <div>
            <SectionLabel num="02" title="Skills" accent={accent} />
          ...
          <div className="hidden md:block font-mono text-[11px] text-white/40 text-right">
            <div>
              active_role ={' '}
              <span style={{ color: accent }}>&quot;{ROLES[activeRole].label}&quot;</span>
            </div>
