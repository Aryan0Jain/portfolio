...
import { ROLES, EXPERIENCE, type RoleKey, type ExperienceItem } from '@/lib/data'
...
export default function Experience({ activeRole }: ExperienceProps) {
  const accent = ROLES[activeRole].accent

  return (
    <section id="experience" className="relative py-20">
      <div className="mx-auto max-w-7xl px-6">
        <SectionLabel num="04" title="Experience" accent={accent} />
...
function TimelineItem({ e, accent }: { e: ExperienceItem; accent: string }) {
  return (
