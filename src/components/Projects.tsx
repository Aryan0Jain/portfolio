...
import { ROLES, PROJECTS, type RoleKey, type Project } from '@/lib/data'
...
export default function Projects({ activeRole }: ProjectsProps) {
    ...
    <section id="projects" className="relative py-20">
      <div className="mx-auto max-w-7xl px-6">
        <div className="flex items-end justify-between gap-6">
          <div>
            <SectionLabel num="03" title="Selected work" accent={accent} />
